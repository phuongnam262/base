...
import com.lock.basesource.data.preference.PreferenceHelper
import com.lock.basesource.util.ApiException
...
class AuthInterceptor(requireToken: Boolean) : Interceptor {
    private val requireToken = requireToken
