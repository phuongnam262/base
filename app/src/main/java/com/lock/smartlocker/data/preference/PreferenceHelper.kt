package com.lock.smartlocker.data.preference
...
class PreferenceHelper {
    companion object {
         ...
         * @param vararg isEmpty is remove all key
         */
        fun removeAllKey(vararg arrKeyNotRV: String?): Boolean {
            return if (arrKeyNotRV.isEmpty()) {
